...
Route::get('/robots.txt', function () {
    return Response::make("User-agent: *\nAllow: /\n\nSitemap: https://thehorizonsunlimited.com/sitemap.xml", 200)
...
Route::get('premium-courses', [homeController::class, 'premium_courses'])->name('premium-courses');
Route::get('premium-course-details', [homeController::class, 'premium_course_details'])->name('premium-course-details');
