...
<div class="container">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{route('fees.online.update', $fee->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
              <div class="card-body">
                ...
                <select class="form-select form-select-lg mb-3 form-control" aria-label=".form-select-lg example" name="university_id">
                    ...
                    <option value="{{$item->id}}" {{ $fee->university_id == $item->id ? 'selected' : '' }}>{{$item->name}}</option>
                    @endforeach
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Add title of program" name="program" value="{{$fee->program}}" >
                </div>

                <div class="form-group">
                    <label for="exampleInputName"> Program (short name)  </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Add title of program short name" name="short_name" value="{{$fee->short_name}}" >
                </div>

                <div class="form-group">
                    <label for="exampleInputName"> Total Fee  </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Add Total Course Fee" name="total_fee" value="{{$fee->total_fee}}">
                </div>

                <div class="form-group">
                    <label for="exampleInputName"> Yearly Fee  </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Add Yearly Fee" name="yearly" value="{{$fee->yearly}}">
                </div>

                <div class="form-group">
                    <label for="exampleInputName"> Duration  </label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Duration" name="duration" value="{{$fee->duration}}">
                </div>
