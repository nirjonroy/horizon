...
@section('content')
<!--University Slider-->
<section class="pt-16 lg:pt-40 max-w-7xl mx-auto">
    ...
    <h1
      class="text-4xl lg:text-start px-4 text-center font-bold text-gray-700 mt-4 mb-6"
    >
    {{($studies->name)}}
    </h1>
    <p
      class="lg:w-3/4 w-full px-4 lg:text-start text-center font-semibold text-gray-500 text-xl"
    >
      {!!$studies->short_description!!}
    </p>

    <div class="w-full bg-primary py-12 px-0 lg:px-12 my-10 max-w-7xl">
      <div
      ...
      >
        ...
        >
          <div class="flex flex-col gap-4">
            <div
              class="h-48 max-w-60 rounded-md py-4 bg-red flex flex-col justify-center align-items-center"
            >
              <h1
                class="lg:text-4xl text-3xl text-center font-bold text-white mb-4"
              >

              </h1>
              <p
                class="text-xl text-center font-semibold mt-1 px-2 text-white"
              >
              {!!$studies->rated!!}
              </p>
            </div>
            <div
              class="h-48 max-w-60 rounded-md py-4 bg-white flex flex-col justify-center align-items-center"
            >
              <h1
                class="text-4xl text-center font-bold text-gray-700 text-black mb-4"
              >

              </h1>
              <p
                class="text-xl text-center font-semibold mt-1 px-2 text-black"
              >
              {!!$studies->rated!!}
              </p>
            </div>
          ...
          <div class="flex flex-col gap-4">
            ...
            <div
              class="h-48 max-w-60 rounded-md py-4 bg-red flex flex-col justify-center align-items-center"
            >
              <h1 class="text-4xl text-center font-bold text-white mb-4">
        ...
        <div class="lg:w-7/12 lg:mt-0 mt-8">
          <div class="w-full h-full bg-red-200">
            <img
              ...
              class="w-full rounded-md sm:block hidden"
            />
          </div>
          <div
          ...
          >
            <img
              src="{{asset($studies->image_2)}}"
              class="w-full rounded-md"
              alt="kitchen"
            />
            <img
              src="{{asset($studies->image_3)}}"
              class="w-full rounded-md"
              alt="sitting room"
            />
          </div>
  ...
  <!--Why Liverpool University-->
  <section class="bg-primary pb-10">
    <div class="container max-w-7xl mx-auto space-y-6 sm:space-y-12">
      <h1
        class="text-5xl text-white text-center lg:text-start mb-5 font-bold pt-10"
      >
        Why Students Love  {{$studies->name}} !!!
      </h1>
      @if(!empty($cover->id))
      <a
    ...
    @endif
      ...
      <!-- <div class="flex justify-center">
        <button
          type="button"
          class="px-6 py-3 text-sm rounded-md hover:underline bg-white rounded-md font-bold mb-10"
        >
          Load more posts...
        </button>
      </div> -->
